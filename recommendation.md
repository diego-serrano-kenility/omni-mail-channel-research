...
2. **Costo mas bajo a escala** - $0.10/1K fijo, sin tiers ni suscripciones mensuales. A partir de volumen moderado es significativamente mas economico que las alternativas ($0.10/1K vs $0.35-0.90/1K de SendGrid segun plan, o $0.63/1K de Brevo). Nota: el free tier permanente de 62K/mes desde EC2 fue eliminado en agosto 2023; ahora solo se ofrecen 3,000 msg charges/mes por 12 meses para cuentas nuevas
...
| 6   | **Costo SES sin free tier permanente** - El free tier de 62K/mes fue eliminado; se paga desde el primer email              | N/A          | **Bajo** | A $0.10/1K, el costo total sigue siendo muy bajo (~$3-6/mes para produccion baja). Significativamente menor que alternativas.                                                             |
