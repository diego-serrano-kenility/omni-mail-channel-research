...
### Limites de envio y tamanio de mensaje
- Mail Send API Overview - Limitations (tamanio max mensaje: 30 MB incluyendo headers, body y attachments): <https://docs.sendgrid.com/api-reference/mail-send/limitations>
