...
| **SMTP + SES Inbound**      | SMTP cliente | Forwarding -> SES -> S3/SNS (subdomain propio)  | **0 cambios** cliente | DIY outbound                         | ~$0.10/1K (SES)      | Media-Alta  |
...
| Proveedor                       | Limite diario          | Limite por minuto | Tamaño max mensaje |
| ------------------------------- | ---------------------- | ----------------- | ------------------ |
